  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 70% 45% at 15% 15%, rgba(194,65,12,0.06) 0%, transparent 60%),
            radial-gradient(ellipse 60% 40% at 85% 75%, rgba(185,28,28,0.04) 0%, transparent 55%),
            #f4f1ed
          `,
        }}
      />
