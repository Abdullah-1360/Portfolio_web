...
export const portfolioData: PortfolioData = {
  ...
  skills: [
    // Automation
    { name: 'n8n',           level: 'Proficient',  category: 'Automation' },
    { name: 'UChat',         level: 'Proficient',  category: 'Automation' },
    { name: 'AI Workflows',  level: 'Proficient',  category: 'Automation' },
    // AI / LLM Ops
    { name: 'MCP Dev',       level: 'Proficient',  category: 'AI / LLM Ops' },
    { name: 'LLM Quant.',    level: 'Familiar',    category: 'AI / LLM Ops' },
    { name: 'Prompt Eng.',   level: 'Proficient',  category: 'AI / LLM Ops' },
    { name: 'Ollama',        level: 'Familiar',    category: 'AI / LLM Ops' },
    // Full-Stack
    { name: 'Node.js',       level: 'Proficient',  category: 'Full-Stack' },
    { name: 'Express.js',    level: 'Proficient',  category: 'Full-Stack' },
    { name: 'MongoDB',       level: 'Proficient',  category: 'Full-Stack' },
    { name: 'Flutter/Dart',  level: 'Proficient',  category: 'Full-Stack' },
    { name: 'Python',        level: 'Familiar',    category: 'Full-Stack' },
    // DevOps & Infra
    { name: 'Ansible',       level: 'Familiar',    category: 'DevOps & Infra' },
    { name: 'Linux Admin',   level: 'Familiar',    category: 'DevOps & Infra' },
    { name: 'Git',           level: 'Proficient',  category: 'DevOps & Infra' },
    { name: 'WHM/cPanel',    level: 'Familiar',    category: 'DevOps & Infra' },
  ] as any,
