...
export const portfolioData: PortfolioData = {
  ...
  skills: [
    { name: 'LangGraph',        level: 'Proficient' as const, category: 'AI & LLMs',   useCase: 'Stateful multi-agent candidate evaluation graph', linkedProject: 'HR_AI Hiring Platform' },
    { name: 'LangChain',        level: 'Proficient' as const, category: 'AI & LLMs',   useCase: 'Document loading, prompt templates & RAG pipelines', linkedProject: 'HR_AI Hiring Platform' },
    { name: 'Multi-LLM Router', level: 'Proficient' as const, category: 'AI & LLMs',   useCase: 'Zero-downtime 6+ provider fallback & cost optimization', linkedProject: 'Multi-LLM Fallback Engine' },
    { name: 'MCP Dev',          level: 'Proficient' as const, category: 'AI & LLMs',   useCase: 'Model Context Protocol servers for DB & tool binding', linkedProject: 'MCP Infrastructure' },
    { name: 'LLM Quant.',       level: 'Familiar'   as const, category: 'AI & LLMs',   useCase: 'Model quantization (GGUF/AWQ) for low-latency local inference', linkedProject: 'Local AI Benchmarks' },
    { name: 'Prompt Eng.',      level: 'Proficient' as const, category: 'AI & LLMs',   useCase: 'Structured JSON output, tool calling & safety guardrails', linkedProject: 'HR_AI Hiring Platform' },
    { name: 'Ollama',           level: 'Familiar'   as const, category: 'AI & LLMs',   useCase: 'Local offline Llama 3 & DeepSeek model deployment', linkedProject: 'Multi-LLM Fallback Engine' },
