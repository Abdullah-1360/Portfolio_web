...
export const portfolioData: PortfolioData = {
  ...
  skills: [
    { name: 'LangGraph',        level: 'Proficient' as const, category: 'AI / LLM Ops',   useCase: 'Stateful multi-agent candidate evaluation graph', linkedProject: 'HR_AI Hiring Platform' },
    { name: 'LangChain',        level: 'Proficient' as const, category: 'AI / LLM Ops',   useCase: 'Document loading, prompt templates & RAG pipelines', linkedProject: 'HR_AI Hiring Platform' },
    { name: 'Multi-LLM Router', level: 'Proficient' as const, category: 'AI / LLM Ops',   useCase: 'Zero-downtime 6+ provider fallback & cost optimization', linkedProject: 'Multi-LLM Fallback Engine' },
    { name: 'MCP Dev',          level: 'Proficient' as const, category: 'AI / LLM Ops',   useCase: 'Model Context Protocol servers for DB & tool binding', linkedProject: 'MCP Infrastructure' },
    { name: 'LLM Quant.',       level: 'Familiar'   as const, category: 'AI / LLM Ops',   useCase: 'Model quantization (GGUF/AWQ) for low-latency local inference', linkedProject: 'Local AI Benchmarks' },
    { name: 'Prompt Eng.',      level: 'Proficient' as const, category: 'AI / LLM Ops',   useCase: 'Structured JSON output, tool calling & safety guardrails', linkedProject: 'HR_AI Hiring Platform' },
    { name: 'Ollama',           level: 'Familiar'   as const, category: 'AI / LLM Ops',   useCase: 'Local offline Llama 3 & DeepSeek model deployment', linkedProject: 'Multi-LLM Fallback Engine' },
    { name: 'n8n',              level: 'Proficient' as const, category: 'Automation',     useCase: '10,000+ server self-healing workflows & reboot loops', linkedProject: 'HostBreak Self-Healing' },
    { name: 'UChat',            level: 'Proficient' as const, category: 'Automation',     useCase: 'Conversational AI bot integration & channel routing', linkedProject: 'Support Bot Platform' },
    { name: 'AI Workflows',     level: 'Proficient' as const, category: 'Automation',     useCase: 'End-to-end webhook automation & event-driven processing', linkedProject: 'HostBreak Infrastructure' },
    { name: 'Ansible EDA',      level: 'Proficient' as const, category: 'Automation',     useCase: 'Event-driven Ansible rulebooks for autonomous server fixes', linkedProject: 'HostBreak Self-Healing' },
    { name: 'FastAPI',          level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'High-throughput async Python APIs & background tasks', linkedProject: 'HR_AI Backend' },
    { name: 'PostgreSQL',       level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'Stateful candidate relational DB & workflow tracking', linkedProject: 'HR_AI Database' },
    { name: 'Node.js',          level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'Scalable backend services & real-time webhook listeners', linkedProject: 'HostBreak Microservices' },
    { name: 'Express.js',       level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'REST API endpoints & microservice integration', linkedProject: 'Automation Bridge' },
    { name: 'MongoDB',          level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'Document storage for unstructured payload logs & telemetry', linkedProject: 'Telemetry Pipeline' },
    { name: 'Flutter/Dart',     level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'Cross-platform mobile UI for server status & monitoring', linkedProject: 'Mobile Server Dashboard' },
    { name: 'Python',           level: 'Proficient' as const, category: 'Full-Stack',     useCase: 'LangGraph agents, ML scripts & stealth CI auto-push', linkedProject: 'HR_AI Engine' },
    { name: 'Redis',            level: 'Proficient' as const, category: 'DevOps & Infra', useCase: 'Distributed locking, rate-limiting & session caching', linkedProject: 'HR_AI Fallback Router' },
    { name: 'Ansible',          level: 'Familiar'   as const, category: 'DevOps & Infra', useCase: 'Infrastructure as Code playbook automation for Linux fleets', linkedProject: 'HostBreak Orchestration' },
    { name: 'Linux Admin',      level: 'Familiar'   as const, category: 'DevOps & Infra', useCase: 'Kernel tuning, systemd services & server administration', linkedProject: '10,000+ Server Fleet' },
    { name: 'Git',              level: 'Proficient' as const, category: 'DevOps & Infra', useCase: 'Stealth automated commit sync & Conventional Commits', linkedProject: 'HR_AI Auto-Sync' },
    { name: 'WHM/cPanel',       level: 'Familiar'   as const, category: 'DevOps & Infra', useCase: 'Web hosting server administration & DNS automation', linkedProject: 'HostBreak Fleet' },
  ],
